          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              ...
              <p className="text-lg text-muted-foreground max-w-lg animate-fade-in animation-delay-200">
                Hi, I'm Lawrence A. Udoh, a software engineer specializing in
                React/NextJS/Typescript, C#/.NET, and NestJS/ExpressJS/NodeJS. I
                create seamless web experiences and robust backend solutions.
              </p>
            </div>
            {/* CTAs */}
          ...
          <div className="relative animate-fade-in animation-delay-300">
            ...
            <div className="relative max-w-md mx-auto">
              ...
              <div className="relative glass rounded-3xl p-2 glow-border">
                ...
                />
                {/* Floating Badge */}
                <div className="absolute rounded-full -bottom-4 -right-4 glass px-4 py-3 animate-float">
